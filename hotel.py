...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        #1st img
        img1=Image.open(r"C:\Users\ksing\OneDrive\Desktop\Projects\images\logo.jpg")
        img1=img1.resize((1700,140),Image.ANTIALIAS)
        self.photoimg1=ImageTk.PhotoImage(img1)

        lbling=Label(self.root,image=self.photoimg1,bd=4,relief=RIDGE)
        lbling.place(x=0,y=0,width=1700,height=140)
        #logo
        img2=Image.open(r"C:\Users\ksing\OneDrive\Desktop\Projects\images\logo.jpg")
        img2=img2.resize((260,140),Image.ANTIALIAS)
        self.photoimg2=ImageTk.PhotoImage(img2)

        lbling=Label(self.root,image=self.photoimg2,bd=4,relief=RIDGE)
        lbling.place(x=0,y=0,width=260,height=140)
        #title
        ...
        #****right side image****
        img3=Image.open(r"C:\Users\ksing\OneDrive\Desktop\Projects\images\oswald-elsaboath-ym_EI-DTS1g-unsplash.jpg")
        ...
        #********down images***
        img4=Image.open(r"C:\\Users\\ksing\Downloads\\valeriia-bugaiova-_pPHgeHz1uk-unsplash.jpg")
        ...
        img5=Image.open(r"C:\\Users\\ksing\Downloads\\louis-hansel-iBfVwYwA3ek-unsplash.jpg")
